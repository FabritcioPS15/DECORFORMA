        ...
        <Reveal width="100%">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#contacto"
                className="flex items-center justify-center gap-2.5 border-2 border-[#1A8FBB] text-white hover:bg-[#1A8FBB] font-bold px-8 py-4 rounded-xl transition-all duration-200 hover:scale-105 text-base gap-2"
              >
