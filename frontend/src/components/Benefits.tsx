        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((b, i) => {
            ...
            return (
              <div
                key={b.title}
                className={`group bg-white border border-gray-100 rounded-2xl p-7 hover:shadow-xl hover:border-[#1A8FBB]/30 transition-all duration-500 hover:-translate-y-1 ${
                  inView
