    ...
    >
      {tooltip && (
        <div className="flex items-center gap-2 bg-white rounded-xl shadow-xl px-4 py-3 max-w-[220px] border border-gray-100">
          <p className="text-[#0B2545] text-xs font-medium leading-snug">
            Cotiza gratis por WhatsApp. Respuesta en minutos.
          </p>
          <button
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] shadow-xl shadow-green-900/30 flex items-center justify-center hover:scale-110 transition-all duration-200 hover:shadow-2xl hover:shadow-green-900/40"
      >
        <svg
