...
const slides = [
  {
    ...
    subtitle: 'Distribuci├│n Optimizada',
    description: 'Dise├▒os funcionales con acabados premium. Aprovecha cada espacio de tu cocina con estilo y elegancia.',
    cta1: 'Cotizar ahora',
    cta2: 'Ver Galer├¡a',
    stats: [
  ...
  },
  {
    ...
    description: 'Aprovecha cada cent├¡metro con m├│dulos, cajones y herrajes a tu gusto. Soluciones de almacenamiento premium.',
    cta1: 'Dise├▒ar mi closet',
    cta2: 'Ver Modelos',
    stats: [
  ...
  },
  {
    ...
    cta1: 'Pedir Cotizaci├│n',
    cta2: 'Ver Dise├▒os',
    stats: [
      { value: 'Moderno', label: 'Minimalista' },
      { value: 'Led', label: 'Iluminaci├│n' },
      { value: 'Pro', label: 'Instalaci├│n' },
    ]
  },
  {
    ...
    subtitle: 'Dise├▒o Corporativo',
    description: 'Espacios de trabajo con personalidad. Escritorios, estantes y mobiliario dise├▒ado para la excelencia profesional.',
    cta1: 'Equipar Oficina',
    cta2: 'Casos de ├ëxito',
    stats: [
      { value: '+120', label: 'Empresas' },
      { value: 'Elite', label: 'Acabados' },
      { value: 'Ergo', label: 'Dise├▒o' },
    ]
  },
  {
    ...
    description: 'Camas, cl├│sets y estaciones de estudio pensadas para crecer contigo. Funcionalidad y dise├▒o en armon├¡a.',
    cta1: 'Ver Proyectos',
    cta2: 'Solicitar Planos',
    stats: [
      { value: 'Kids', label: 'Seguro' },
      { value: 'Color', label: 'Variedad' },
      { value: 'Smart', label: 'M├│dulos' },
    ]
  }
];
