        ...
        <main className="bg-[#061230] min-h-screen">
                ...
                <div className="relative max-w-6xl mx-auto px-5 w-full">
                    <Reveal y={30}>
                        <h1 className="text-3xl md:text-6xl font-bold text-white leading-tight mb-8 max-w-2xl">
                            ...
                            <span className="text-[#22BDDD]">Con Pasi├│n y Precisi├│n</span>
                        </h1>
                        <p className="text-white/70 text-base md:text-xl max-w-xl leading-relaxed">
                            Desde hace m├ís de 10 a├▒os, Decorforma combina la tradici├│n de la carpinter├¡a fina con la innovaci├│n de la melamina moderna.
                        </p>
                    </Reveal>
                </div>
            </section>
            ...
            <section className="relative -mt-12 md:-mt-16 z-10 px-5 mb-24">
                <div className="max-w-6xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        { label: 'A├▒os de Experiencia', value: 10, suffix: '+', icon: Award },
                    ...
                    <Reveal x={-30}>
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                            <img
                                ...
                                alt="Dise├▒o de interiores premium"
                            />
                    ...
                    <div className="space-y-10">
                        <Reveal y={20}>
                            ...
                            <p className="text-white/60 text-lg leading-relaxed">
                                En Decorforma, no solo fabricamos muebles; creamos soluciones que integran dise├▒o, funcionalidad y durabilidad. Nuestra obsesi├│n es el detalle y la satisfacci├│n de ver plasmada la visi├│n de nuestros clientes.
                            </p>
                        </Reveal>

                        <div className="grid sm:grid-cols-2 gap-8">
                            {[
                                { title: 'Excelencia CNC', desc: 'Precisi├│n milim├®trica en cada corte utilizando tecnolog├¡a de punta.', icon: Zap },
                                { title: 'Calidad PUR', desc: 'Cantos pegados con tecnolog├¡a PUR para una resistencia total al calor y la humedad.', icon: ShieldCheck },
                            ].map((feature, i) => (
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        <Reveal y={20}>
                            <div className="p-8 rounded-3xl bg-[#0B2545]/50 border border-white/5 hover:bg-[#0B2545] transition-all duration-300">
                                <h3 className="text-2xl font-bold text-[#22BDDD] mb-4">Nuestra Misi├│n</h3>
                                <p className="text-white/60 leading-relaxed">
                                    Dise├▒ar y fabricar mobiliario a medida que supere las
                                    expectativas de nuestros clientes en dise├▒o, calidad y
                                    funcionalidad, empleando materiales de primera
                                    categor├¡a y procesos innovadores que permitan
                                    transformar cada hogar y oficina en espacios ├║nicos,
                        ...
                        <Reveal y={20} delay={0.2}>
                            <div className="p-8 rounded-3xl bg-[#0B2545]/50 border border-white/5 hover:bg-[#0B2545] transition-all duration-300">
                                <h3 className="text-2xl font-bold text-[#22BDDD] mb-4">Nuestra Visi├│n</h3>
                                <p className="text-white/60 leading-relaxed">
                                    Consolidarnos como la empresa l├¡der en el Per├║ en
                                    dise├▒o y fabricaci├│n de muebles de melamina y madera,
                                    reconocida por nuestra excelencia operativa, innovaci├│n
                                    permanente y un compromiso sostenido con la calidad,
                                    la sostenibilidad y la satisfacci├│n integral de nuestros
                                    clientes.
                    ...
                    <Reveal y={20} width="100%">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-white/50 max-w-2xl mx-auto">
                                Trabajamos con aglomerados de alto est├índar,
            ...
            <section className="py-20 md:py-32 border-t border-white/5">
                <div className="max-w-6xl mx-auto px-5">
                    ...
                    <div className="grid md:grid-cols-4 gap-8 relative">
                        ...
                        {[
                            { step: '01', title: 'Consulta & Dise├▒o', desc: 'Escuchamos tus necesidades y creamos los planos 3D iniciales.' },
                            { step: '02', title: 'Cotizaci├│n Clara', desc: 'Presupuesto detallado y transparente sin sorpresas ocultas.' },
                            { step: '03', title: 'Fabricaci├│n CNC', desc: 'Corte y perforado de alta precisi├│n en nuestro taller.' },
                            { step: '04', title: 'Instalaci├│n Final', desc: 'Montaje profesional cuidando cada detalle de tu espacio.' },
                        ].map((item, i) => (
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
                        <div className="space-y-8 lg:order-2">
                            <Reveal y={20}>
                                ...
                                <p className="text-white/60 text-lg leading-relaxed">
                                    Contamos con un taller propio equipado con tecnolog├¡a de ├║ltima generaci├│n. Nuestra planta de producci├│n est├í dise├▒ada para maximizar la calidad y eficiencia, asegurando que cada pieza de melamina y madera cumpla con los est├índares m├ís exigentes del mercado.
                                </p>
                ...
                <Reveal y={20} width="100%">
                    <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-[#1A8FBB] to-[#116483] rounded-[3rem] p-8 md:p-20 shadow-2xl relative overflow-hidden group">
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-8 relative z-10">
                            ┬┐Listo para dar vida <br /> a tu pr├│ximo proyecto?
                        </h2>
                        <p className="text-white/80 text-lg mb-12 max-w-2xl mx-auto relative z-10">
                            Conversa con nosotros y descubre c├│mo nuestra maestr├¡a en melamina y madera puede transformar tu espacio.
                        </p>
                        <a
                            href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Hola Decorforma, vengo de ver su historia y me gustar├¡a recibir informaci├│n y cotizar mi proyecto.')}`}
                            target="_blank"
